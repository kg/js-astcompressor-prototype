...
echo // input
pigz -11 -f -k $INFILE
third_party/bro --force --quality 11 --input $INFILE --output $INFILE.brotli
...
pigz -11 -f -k Test/$FILE_PREFIX.webasm
third_party/bro --force --quality 11 --input Test/$FILE_PREFIX.webasm --output Test/$FILE_PREFIX.webasm.brotli
